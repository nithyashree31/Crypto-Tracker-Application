    ...
    private void getData() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, response -> {
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(MainActivity.this, "Something went a miss. Please try again later", Toast.LENGTH_SHORT).show();
            }
            ...
            public Map<String, String> getHeaders() {
                ...
                headers.put("X-CMC_PRO_API_KEY", "f16b13cd-75b3-46ef-82fd-42bf96689617");
